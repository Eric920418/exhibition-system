  ...
  return (
    <div className="p-4 md:p-8 pt-20 md:pt-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">文件管理</h1>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  {doc.mimeType && (
                    <p className="text-xs text-gray-500 mt-1">{doc.mimeType}</p>
                  )}
                </div>
                <span className="ml-2 px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800 whitespace-nowrap">
                  {documentTypeLabels[doc.type]}
                </span>
              </div>
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div>
                  <span className="text-gray-500">展覽：</span>
                  <span className="text-gray-900">{doc.exhibition.name}</span>
                </div>
                <div>
                  <span className="text-gray-500">大小：</span>
                  <span className="text-gray-900">{formatFileSize(doc.fileSize ? Number(doc.fileSize) : null)}</span>
                </div>
                <div>
              ...
              <div className="text-xs text-gray-500">
                上傳於 {new Date(doc.uploadedAt).toLocaleDateString('zh-TW')}
              </div>
