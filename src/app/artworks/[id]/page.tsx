      ...
      <section className="max-w-5xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="bg-white rounded-[12px] border border-[rgba(52,58,64,0.12)] p-6" {...scrollAnimate('fade-in-up')}>
            ...
            {artwork.team?.instagramUrl && (
              <div className="mb-4">
                <p className="text-xs font-medium text-[#828282] mb-1">Instagram</p>
                <a
                  href={artwork.team.instagramUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 text-sm text-[#4f4f4f] font-light hover:text-[#e1306c] transition-colors break-all"
                >
